...
public class TestcaseListaDeDeseosPropia {
  ...
  @Test
  public void testCaseListaDeDeseosPropia() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.service-header > form > input[name=\"item\"]")).clear();
    driver.findElement(By.cssSelector("div.service-header > form > input[name=\"item\"]")).sendKeys("Item1");
    driver.findElement(By.cssSelector("input.btn.btn-default")).click();
    assertEquals("Item1", driver.findElement(By.cssSelector("div.service-header > ul > li")).getText());
    ...
    driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
    driver.findElement(By.linkText("Mis Amigos")).click();
    assertEquals("Item1", driver.findElement(By.cssSelector("div.col-md-6 > ul > li")).getText());
  }
